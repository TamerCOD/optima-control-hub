...
const EntryForm: React.FC<Props> = ({ user, initialData, onClose, onEntryAdded }) => {
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] shadow-2xl flex flex-col max-h-[90vh] w-full max-w-3xl mx-auto overflow-hidden relative">
            {showToast && (
            ...
            <div className="p-3 md:p-3 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center bg-zinc-50 dark:bg-zinc-900">
            ...
            <div className="p-3 md:p-3 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                ...
                {/* Status Bar */}
                <div className="flex items-center justify-between bg-zinc-50 dark:bg-zinc-900 p-3 rounded-2xl text-[10px] font-mono text-zinc-400 mt-auto border border-zinc-200 dark:border-zinc-800 shadow-inner">
            ...
            <div className="p-3 md:p-3 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 flex justify-end gap-4">

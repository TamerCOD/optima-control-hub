...
const TaskDetailModal: React.FC<Props> = ({ 
    ...
    return (
        <div className="fixed inset-0 z-[150] flex justify-end bg-zinc-950 overflow-hidden animate-fade-in">
            <div className="bg-white dark:bg-zinc-900 w-full max-w-5xl h-full flex flex-col shadow-2xl overflow-hidden animate-slide-in border-l border-zinc-200 dark:border-zinc-800">
                {/* Header */}
                ...
                {/* Tabs */}
                <div className="flex bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 px-8">
                    ...
                    {activeTab === 'details' && (
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-[2.5rem] space-y-8 border border-zinc-200 dark:border-zinc-800">
                                    {/* Status */}
                                    <div className="space-y-2">
                                        ...
                                        <select 
                                            ...
                                            disabled={!permissions.canChangeStatus}
                                            className="w-full p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-xs font-bold uppercase dark:text-white outline-none focus:border-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-inner"
                                        >
                                            {(() => {
                                                const activeWorkflow = project?.workflowId 
                                                    ? taskSettings.workflows?.find(w => w.id === project.workflowId) 
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <input 
                                                ...
                                                disabled={!permissions.canEditTask}
                                                className="w-full p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-xs font-bold dark:text-white outline-none focus:border-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-inner"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <input 
                                                ...
                                                disabled={!permissions.canEditTask}
                                                className="w-full p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-xs font-bold dark:text-white text-center disabled:opacity-50 disabled:cursor-not-allowed shadow-inner"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                ...
                                {project?.customFields && project.customFields.length > 0 && (
                                    <div className="bg-zinc-50 dark:bg-zinc-900 p-4 rounded-[2.5rem] space-y-6 border border-zinc-200 dark:border-zinc-800">
                                            ...
                                            <div key={cf.id} className="space-y-2">
                                                ...
                                                {cf.type === 'textarea' && (
                                                    <textarea 
                                                        ...
                                                        onChange={e => setTask({ ...task, customFieldValues: { ...task.customFieldValues, [cf.id]: e.target.value } })}
                                                        disabled={!permissions.canEditFields}
                                                        className="w-full p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-xs font-bold dark:text-white outline-none focus:border-primary transition-all resize-none h-24 disabled:opacity-50 disabled:cursor-not-allowed shadow-inner"
                                                    />
                                                )}

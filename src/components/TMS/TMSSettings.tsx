        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid gap-4">
                {localSettings.statuses.map((status, idx) => (
                    <div key={status.id} className="p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl grid grid-cols-12 gap-6 items-center group shadow-sm">
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid gap-8">
                {(localSettings.workflows || []).map((wf, wfIdx) => (
                    <div key={wf.id} className="p-3 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl space-y-6 shadow-sm">
                ...
                {(!localSettings.workflows || localSettings.workflows.length === 0) && (
                    <div className="text-center p-12 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl text-zinc-400 text-xs font-black uppercase">
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid gap-4">
                {localSettings.taskTypes.map((type, idx) => (
                    <div key={type.id} className="p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl grid grid-cols-12 gap-6 items-center shadow-sm">
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid gap-4">
                {localSettings.priorities.map((prio, idx) => (
                    <div key={prio.id} className="p-3 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl grid grid-cols-12 gap-6 items-center shadow-sm">
                        <div className="col-span-1 text-2xl text-center">
                            <input 
                                value={prio.emoji} 
                                onChange={e => {
    ...
    const IntegrationEditor = () => {
        ...
        return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Telegram */}
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 space-y-8 shadow-sm">
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 space-y-8 shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 p-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl col-span-2">
                            <input 
                                type="checkbox" 
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm">
                ...
                <div className="grid gap-6">
                    {Object.entries(localSettings.notifications).map(([key, config]: [string, any]) => (
                        <div key={key} className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl group hover:border-primary transition-all shadow-sm">
                            <div>
